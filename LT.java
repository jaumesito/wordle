...
public class LT {
    ...
    //CORRESPONDENCIA ÍNDICES CON COLORES PARA MÉTODO visualizadorColorTrazado
    //Y MÉTODO visualizadorColorFondo
    //  ROJO     --> 0
    //  VERDE    --> 1
    //  AZUL     --> 2
    //  AMARILLO --> 3
    ...
    private static final String [] COLOR={"\u001B[31m","\u001B[32m","\u001B[33m",
                                          "\u001B[34m","\u001B[35m","\u001B[36m",
                                          "\u001B[37m"};
    ...
    public static void visualizadorColorTrazado(String texto, int [] colorIndex) {
        String mensaje="";
    ...
    public static void visualizadorColorFondo(String texto,int [] colorIndex) {
        for (int i=0;i<texto.length();i++) {     
            System.out.print((char)27+"[30;"+(41+colorIndex[i])+"m"+" "+texto.charAt(i)+" ");
